    ...
    <section className="max-w-screen-xl bg-gray-400 bg-opacity-10 p-10 my-10 rounded-md">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-2 px-10 pt-4 cursor-pointer">
          <div className="border-2 border-dotted border-t-0 border-s-0 ps-20 py-5">
            <img className="w-12" src={chicken} alt="" />
            <h4 className="text-lg font-semibold">Chicken</h4>
          </div>
          <div className="border-2 border-dotted border-t-0 border-x-0 ps-20 py-5">
          ...
          <div className="border-2 border-dotted  border-y-0 border-s-0 ps-20 py-5">
            <img className="w-12" src={soup} alt="" />
            <h4 className="text-lg font-semibold">Soups</h4>
          </div>
          <div className="border-2 border-dotted border-y-0 border-x-0 ps-20 py-5">
